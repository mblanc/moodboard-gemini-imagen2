...
prompt = """
Generate 8 creative prompts for Imagen to create images illustrating the input topics.
One prompt per line without a number a dash or a bullet.
Just the prompt.
No Line return between prompts.
...
gemini_element.write("Prompts generated by Gemini based on the topics :")
...
imagen_element.write("Images generated by Imagen 2")

print("INIT VERTEX")
vertexai.init(project="svc-demo-vertex", location="us-central1")


textmodel = GenerativeModel("gemini-pro")
